...
```
Mean of total number of steps taken per day is: `r mean_steps_day`
Median of total number of steps taken per day is: `r median_steps_day`
...
Which 5-minute interval, on average accross all the days in the dataset, contains the maximum number of steps?: `r max_interval`  
